...
const Category = () => {
    ...
    const assignPageText = () => {
        ...
        if (categorySelected==="PSG") setText("Highland Technology pulse generators translate low-level signals with slow edges into clean, fast pulses with amplitudes of up to 100V. DC and transformer coupled models are available.")
        ...
        if (categorySelected==="OEM") setText("For almost 40 years Highland has provided custom electronics for challenging customer applications. Areas of expertise include: Picosecond timing, Precision analog and mixed signal processing, Digital delay and pulse generation, High speed photonics and fiberoptic timing distribution, and Aerospace instrumentation and simulation. Products demonstrating these capabilities are shown here.")
        if (categorySelected==="LEG") setText("Highland is committed to providing long-term availability of products and product support. The following products are not recommended for new design due to difficulty stocking components and high component costs. Highland will continue to support existing customers by producing and maintaining these designs whenever possible. New customers are encouraged to consider replacement products.")
    }
