...
let productSeed = [
      ...
      // ****************************** T560 Data ******************************
      {
        ...
        config: [
          ...
          [1, "stand-alone digital delay and pulse generator with Ethernet"],
          [2, "evaluation kit (T560 factory installed on mounting flange with Ethernet, power supply, two 3' SMB cables, and one RS-232 cable)"],
          [3, "stand-alone digital delay and pulse generator with OCXO option"],
          [4, "stand-alone digital delay and pulse generator with Ethernet and OCXO option"],
          ],    
        ],
        versions: [
          [[0], 1, ["stand-alone digital delay and pulse generator"]], 
          [[1], 2, ["stand-alone digital delay and pulse generator with Ethernet"]], 
          [[2], 9, ["evaluation kit (T560 factory installed on mounting flange with Ethernet, power supply, two 3' SMB cables, and one RS-232 cable)"]],
          [[3], 31, ["stand-alone digital delay and pulse generator with OCXO option"]], 
          [[4], 32, ["stand-alone digital delay and pulse generator with Ethernet and OCXO option"]], 
        ],
        accessories: [],
        driversSoftware: [
      ...
      // ****************************** T564 Data ******************************
      {
        ...
        config: [
          ["required", "Configuration", 
          [0, "stand-alone advanced digital delay and pulse generator"], 
          [1, "stand-alone advanced digital delay and pulse generator with Ethernet"],
          [2, "evaluation kit (T564 factory installed on mounting flange with Ethernet, power supply, two 3' SMB cables, and one RS-232 cable)"],
          [3, "stand-alone advanced digital delay and pulse generator with OCXO option"],
          [4, "stand-alone advanced digital delay and pulse generator with Ethernet and OCXO option"],
          ],    
        ],
        versions: [
          [[0], 1, ["stand-alone advanced digital delay and pulse generator"]], 
          [[1], 2, ["stand-alone advanced digital delay and pulse generator with Ethernet"]], 
          [[2], 9, ["evaluation kit (T564 factory installed on mounting flange with Ethernet, power supply, two 3' SMB cables, and one RS-232 cable)"]],
          [[3], 31, ["stand-alone advanced digital delay and pulse generator with OCXO option"]], 
          [[4], 32, ["stand-alone advanced digital delay and pulse generator with Ethernet and OCXO option"]], 
        ],
        accessories: [],
        ECCN: "3A999",
        htsCode: "8543.20.0000",
