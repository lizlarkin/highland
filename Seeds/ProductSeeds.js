...
let productSeed = [
      ...
      features: [
        ...
        ["Pin socket connection to Type-1 butterfly-packaged laser diodes with floating anode, solder connect optional; compatible with other diode packages"],
      ...
      imgCaptions: ["T165 installed on mounting flange (standard for evaluation versions)", "T165 installed on mounting flange (standard for evaluation versions)", "standalone T165 (unmounted)"],
      about: [
      ...
      specifications: [
        ...
        ["TRIGGER INPUT", ["LVTTL/LVCMOS input", "Triggers on input rising-edge, max input: +2.5 volts", "min trigger width:", ["2.5 ns (-2 version)", "250 ns + width program setting (-12, -14 versions)"], "Trigger rate:", ["0 to 200 MHz (-2 version)", "0 to 2 MHz (-12 and -14 versions)"]]],
        ["PROPAGATION DELAY", ["4 ns nominal (-2 and -9 versions)", "250 ns nominal (-12 and -14 versions)"]],
        ["LASER OUTPUT", ["Pulsed laser current adjustable 0 to 700 mA, + 2.5 volt compliance", "Heat sinking required above 400 mA", "Average laser current 50 mA max", "Width adjustable from:", ["< 300 ps to 2 ns, nominal (-2 version)", "< 5 ns to 850 ns, nominal (-12 version)", "< 5 ns to 850 ns, nominal (-14 version)"]]],
        ["RISE/FALL TIMES", ["150 ps to 1 ns nominal (-2 and -12 versions)", "2.5 ns nominal (-14 version)", "Actual rise/fall times depend on laser electrical parasitics"]],
        ["JITTER", ["< 12 ps RMS (-2 version)", "< 120 ps RMS (-12 and -14 versions)"]],
        ...
        ["POWER", ["+5 volts ± 5% at PCB via USB connector or ribbon header", "Current 300 mA plus laser current", "Highland model J6 USB power supply available for use up to 700 mA laser current"]],
